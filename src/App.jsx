...
const SCHEDULE = [
  {
    ...
    events: [
      ...
      { time: "4:00 PM — 8:00 PM", title: "Eat. Drink. Gamble.", emoji: "🎰",
        location: "The Strip & LINQ Promenade",
        address: "3545 S Las Vegas Blvd, Las Vegas, NV 89109",
        desc: "Free reign. Hit the tables, find a steakhouse, post up at a bar, or explore the Strip. The LINQ Promenade is right there — High Roller, bars, food, all of it. This is your warmup. Pace yourself... Friday night hasn't even started yet. Start wrapping it up by 8 PM — head back to the room, get fresh, and get ready. The party bus will NOT wait for you.",
